...
• Technologies: Python, TensorFlow, Keras, Streamlit, NLP, Pandas  
• Developed an LSTM-based deep learning model for SMS spam classification using natural language processing techniques  
• Implemented text preprocessing, tokenization, sequence padding, and embedding layers for feature extraction  
• Built an interactive Streamlit dashboard with spam probability scoring, confidence analysis, and message statistics  
• Achieved **98.65% classification accuracy** on the SMS Spam Collection dataset
...
LinkedIn:
https://linkedin.com/in/anusreereddysama